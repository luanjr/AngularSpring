package com.luan.comercial.controller;
...
import com.luan.comercial.repository.OportunidadeRepository;
    ...
    public Oportunidade adicionar(@Valid @RequestBody Oportunidade oportunidade)
    {
        ...
        if (oportunidadeExistente.isPresent()) {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST,
                    "Ja existe uma oportunidade para esse prospecto e com a mesma descricao");
        }
